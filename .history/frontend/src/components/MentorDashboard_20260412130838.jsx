...
export default function MentorDashboard() {
  ...
  const handleSubmitReview = async (e) => {
    ...
    try {
      ...
      // Offer to generate AI summary
      setSummaryResult({ reviewId: data._id, summary: null })
    } catch (err) {
  ...
  const handleGenerateSummary = async (reviewId) => {
    ...
    try {
      ...
      setSummaryResult({ reviewId, summary: data.summary })
    } catch (err) {
      setError('Failed to generate AI summary. Check your Gemini API key.')
    } finally {
      setSummarizing(null)
    }
  }
